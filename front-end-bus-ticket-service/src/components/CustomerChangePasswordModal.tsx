...
const CustomerChangePasswordModal: React.FC<CustomerChangePasswordModalProps> = ({
  closeModal,
  setMessage,
  openFailureModal,
  openSuccessModal,
  ...
  const [newPasswordConfirmation, setPasswordConfirmation] = useState<string>('');
  ...
  const changePassword = async () => {
    ...
    // if (token) {
    //   try {
    //     const res = await axios.put(`${API_URL}customer/change-password`, data, {
          ...
          <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="p-4 md:p-5">
              <div className="space-y-4">
                <div>
                  <label htmlFor="password_current" className="block mb-2 text-sm font-medium text-gray-900">
                    Mật khẩu hiện tại
                  </label>
                  <input
                    type="password"
