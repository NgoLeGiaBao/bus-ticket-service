...
const SignIn: React.FC = () => {
  ...
  const handleLogin = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (response.success) {
        ...
        // Save token and role id to local storage
        localStorage.setItem("token", token);
        localStorage.setItem("roleId", String(user.roleId));

        dispatch(setUser({ access_token: token, role: String(user.roleId) })); 
        
        // Redirect to page based on role id
        if (user.roleId === 1) {
            navigate("/bill/shift-billing-summary");
        ...
        <div className="flex flex-wrap items-center">
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2 h-screen">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium text-center">Start managing efficiently today</span>
